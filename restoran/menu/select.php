    ...
    <tbody>
        ...
        <?php foreach($row as $r) ?> 
            <tr>
                ...
                <td><img style ="width:100" src="../upload/<?php echo $r['gambar'] ?>" alt=""></td>
                <td><a href="?f=menu&m=delete&if=<?php echo $r['idmenu'] ?>">Update</td>
                <td><a href="?f=menu&m=update&if=<?php echo $r['idmenu'] ?>">Update</td>
            </tr>
        <?php endforeach ?>
        <?php } ?>
    </tbody>
